...
const Typography = ({ tag = "p", color = "white", fontFamily = "ubuntu", textAlign = "left", fontSize = "fs100", fontWeight = "regular", children }: TypographyTypes & ITypography): ReactElement => {
    return (
