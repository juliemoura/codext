        ...
        <Container id="blog">
            ...
            <CardsContainer>
                <Col xs={24} sm={24} md={9} lg={8} xl={8}>
                    <CardCompany src="https://images.pexels.com/photos/1595385/pexels-photo-1595385.jpeg?cs=srgb&dl=pexels-fox-1595385.jpg&fm=jpg" hashtag="Our creative Team" data="17 June, 2022" title="Running remote offsites and onboardings" subtitle="Running remote offsites and onboardings can be challenging, but with the right preparation and execution, they can be just as effective as in-person events." href="https://pitch.com/blog/running-remote-offsites-and-onboardings" />
                </Col>
                <Col xs={24} sm={24} md={9} lg={8} xl={8}>
